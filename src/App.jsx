...
function App() {
  ...
  //打開
  const handleOpenProductModual = (mode, product) => {
    // 在點擊新增或編輯產品按鈕時改變它的值
    setmodalMode(mode);
    switch (mode) {
      case 'create':
    ...
    try {
      await axios.post(`${BASE_URL}/v2/api/${API_PATH}/admin/product`,{
        data: {
          ...
          is_enabled: tempProduct.price ? 1 : 0
        }
      });
    } catch (error) {
      alert('新增產品失敗');
          ...
          <div className="row">
            <div className="col">
              <div className="d-flex justify-content-between">
                <h2>產品列表</h2>
                <button onClick={()=> handleOpenProductModual('create')} type="button" className="btn btn-primary">
                  建立新的產品
                </button>
              </div>
                    ...
                    <tr key={product.id}>
                      ...
                      <td>
                        <div className="btn-group">
                          <button
                            onClick={()=>handleOpenProductModual('edit', product)}
                            type="button"
